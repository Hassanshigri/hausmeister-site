export const DE = {
  ...
  trust: {
    items: [
      { title: "ZUVERLÄSSIG", text: "Auf uns können Sie sich verlassen." },
      { title: "PÜNKTLICH", text: "Wir halten unsere Termine ein." },
      { title: "FLEXIBEL", text: "Individuelle Lösungen nach Ihren Wünschen." },
